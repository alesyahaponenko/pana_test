...
const StatsPromoCard = () => {
  ...
  return (
    <section className="statsPromoCard mx-auto my-20 w-full max-w-[1200px] bg-carbonBlack p-4 dark:bg-[#17171799] md:rounded-[30px] md:py-[108px] lg:p-[120px] lg:pb-[164px]">
      <div className="mb-20 flex flex-col gap-10">
        <h2 className="mx-auto max-w-[486px] text-center font-aspekta text-[24px] font-medium leading-[31.2px] text-white dark:text-white md:text-[32px] md:font-semibold md:leading-[44.8px] lg:max-w-[985px] lg:text-[44px] lg:leading-[61.6px]">
        ...
        <div className="relative h-[124px] w-full md:h-[246px]">
          <Image
            src={'/static/landing/stats-promo/card1.svg'}
            fill
            alt="Stats Promo"
      ...
      <div className="flex flex-col gap-10 lg:flex-row lg:gap-5">
        <div className="flex flex-col items-center justify-center gap-8 lg:items-start">
          <div className="mx-auto flex max-w-[486px] flex-col gap-5 md:gap-4">
            <h2 className="text-center font-aspekta text-[24px] font-medium leading-[31.2px] text-white dark:text-white md:text-[32px] md:leading-[44.8px] lg:text-left lg:text-[44px] lg:leading-[61.6px]">
            ...
            <p className="text-center font-aspekta text-[16px] leading-[24px] text-smGray lg:max-w-[488px] lg:text-left lg:text-[18px] lg:leading-[28px]">
              Description Created for ambitious eCommerce businessses Description created
            </p>
          </div>
          <GreenButton
            label={'Subscribe'}
